...
function NotFound() {
    ...
    return (<>
        <section className="grid grid-cols-10 lg:hidden w-full h-[100lvh] overflow-hidden uppercase text-black">
            ...
            <div className="col-span-8">
                <div className="flex flex-col items-start justify-center w-full h-[100lvh] uppercase p-5 text-3xl sm:text-5xl">
                    ...
                    <div className={"text-xl sm:text-2xl normal-case mt-5 sm:w-72"}>
        ...
        <div className={"hidden lg:block"}>
            ...
            <a href="/"
               className={"fixed bottom-[1vw] right-[1.94vw] cursor-pointer select-none label z-400 text-[1.25vw] uppercase px-[0.62vw] bg-white rounded-[0.375vw] border border-black whitespace-nowrap rotate-180"} style={{writingMode: 'vertical-lr'}}>
                Back Home
            </a>
            <section
                className={
