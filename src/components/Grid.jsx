...
export default function Grid() {
    ...
    return (<>
        <section className={"grid grid-cols-17 w-full h-[100lvh] overflow-hidden"}>
            ...
            <Column date={"01.25 2025"} content={"les instants chavirés / 7, rue richard lenoir / 93100 montreuil"} artists={artists[0].friday} day={"friday"} onClick={() => handleClick("friday")} menu={1} translateX={translateX.friday} translateY={translateY} color={colors[randomColor][13]}>
            ...
            <Column date={"01.26 2025"} content={"le petit bain / 7, Port de la Gare / 75013 Paris"} artists={artists[0].saturday} day={"saturday"} onClick={() => handleClick("saturday")} menu={2} translateX={translateX.saturday} translateY={translateY} color={colors[randomColor][14]}>
            ...
            <Column date={"01.27 2025"} content={"lafayette anticipations / 9 Rue du Plâtre / 75004 Paris"} artists={artists[0].sunday} day={"sunday"} onClick={() => handleClick("sunday")} menu={3} translateX={translateX.sunday} translateY={translateY} color={colors[randomColor][15]}>
