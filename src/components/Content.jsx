    ...
    return (
        <>
            ...
            >
                <div
                    ref={scrollRef}
                    className="relative p-5 overflow-y-scroll content md:col-span-7 lg:col-span-12"
                >
                    {date && (
                        <div
                            data-content={day}
                    ...
                    >
                        <div
                            className={
                                "flex flex-col gap-0 shrink-0 pointer-events-auto"
                            }
                        >
                        ...
                        >
                            {content &&
                                content.split(" / ").map((textContent, key) => (
                                    <div
                                        key={key}
                                        className={
                                            "border-b border-black w-full pb-2 mb-2"
                                        }
                                    >
                                        {textContent}
                                    </div>
                            ...
                            <div
                                className={
                                    "normal-case text-[1.6vw] leading-[120%] py-5"
                                }
                            >
                                {children}
                            </div>
                    ...
                    <div className="relative flex flex-col gap-48">
                        {artists &&
                            artists.artists.map((artist) => (
                                <div
                                    className={
                                        "h-fit relative z-10 pointer-events-none px-[4vw]"
                                    }
                                    key={artist.id}
                                >
                                    <div
                    ...
                    {date && (
                        <div className="sticky bottom-0 left-0 z-30 flex flex-row items-end justify-end w-full">
                            <div
                                className={
                                    "text-[1.8vw] leading-[100%] uppercase flex flex-row gap-2 p-5"
                                }
                            >
                                <div className="relative overflow-hidden">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        className={"w-[2vw] rotate-90"}
                                        viewBox="0 0 35 36"
                                        fill="none"
                                    >
                                        <path
